...
e.g. is_rotation("doghouse", "usedogho") returns true You can rotate the letters of "usedogho" to create "doghouse" e.g. is_rotation("dog", "dgo") returns false This is not a rotation even though the same letters are used exactly. Note: This is not a permutation problem. I 
